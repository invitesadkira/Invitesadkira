const VISUALS_FIELDS = 'event_id,show_dresscode,dresscode_text,dresscode_colors,dresscode_detail,dresscode_image_url,dresscode_image_urls,show_dress_gifts,show_couplemsg,couplemsg_text,couplemsg_signature,couplemsg_sig_font,couplemsg_sig_size,couplemsg_bold,couplemsg_body_font,parents_size,bible_text_2,bible_ref_2,bible_size,event_color,event_color_2,button_color_choice,button_color_choice_custom,color_hero_names,color_hero_names_custom,color_names,color_names_custom,color_countdown,color_countdown_custom,color_titles,color_titles_custom,color_message,color_message_custom,color_date,color_date_custom,cover_video_url,hero_subtitle,bible_ornament_url,bible_ornament_size,section_titles_size,couplemsg_size,story_size,std_music_continuous,countdown_style,show_youtube_video,youtube_video_url,youtube_video_title,metallic_animation,intake_color_notes,timeline_dot_enabled,body_font_family,body_text_scale,bg_color,card_bg_url,section_florals,section_bgs,bible_font_family,bible_bold,bible_italic,custom_text_title,custom_text_body,custom_text_show_std,custom_text_show_invite,button_style,invite_layout,event_type,invert_names,show_story,groom_name,bride_name,couple_size,show_couple,bg_url,bg_url_mobile,bg_url_desktop,bg_overlay,show_bible,bible_text,bible_ref,show_invite,invite_text,invite_order,invite_blessing,show_parents,groom_parents,bride_parents,show_gallery,gallery_urls,show_manual,manual_items,manual_show_circles,show_schedule,schedule_items,custom_font_family,section_order,story_text,music_url,music_title,iban_message,iban_number,iban_holder,iban_footer,iban_number_2,iban_holder_2,show_venues,final_photo_url,show_final_photo,show_final_photo_names,show_cover,couple_photo_url,couple_video_url,cover_video_fit,video_audio_mode,gift_stores,gift_stores_style,gift_stores_title,gift_stores_message,show_event_faq,event_faq_items,section_titles,schedule_style,gallery_style,blessing_couple_size,date_style,manual_style,story_style,story_photo_url,story_text_color,story_date_color,sponsors_items,show_sponsors,guest_whitelist,guest_whitelist_enabled,show_section_nav';
