const VISUALS_FIELDS = 'event_id,show_dresscode,dresscode_text,dresscode_colors,dresscode_detail,dresscode_image_url,show_dress_gifts,show_couplemsg,couplemsg_text,parents_size,bible_text_2,bible_ref_2,bible_size,event_color,event_color_2,event_color_2_targets,cover_video_url,button_style,invite_layout,event_type,invert_names,show_story,groom_name,bride_name,couple_size,show_couple,bg_url,bg_url_mobile,bg_url_desktop,bg_overlay,show_bible,bible_text,bible_ref,show_invite,invite_text,show_parents,groom_parents,bride_parents,show_gallery,gallery_urls,show_manual,manual_items,show_schedule,schedule_items,custom_font_family,section_order,story_text,music_url,music_title,iban_message,iban_number,iban_holder,iban_footer,show_venues,final_photo_url,show_final_photo,show_event_faq,event_faq_items,schedule_style,gallery_style,blessing_couple_size,date_style,manual_style,story_style,story_photo_url';
