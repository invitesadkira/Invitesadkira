...
const _ICONS = {
  ...
  'calendar-heart':   '<path d="M21 10V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14c0 1.1.9 2 2 2h7"/><path d="M16 2v4"/><path d="M8 2v4"/><path d="M3 10h18"/><path d="M21.29 14.7a2.43 2.43 0 0 0-2.65-.52c-.3.12-.57.3-.8.53l-.34.34-.35-.34a2.43 2.43 0 0 0-2.65-.53c-.3.12-.56.3-.79.53-.95.94-.95 2.48.22 3.55L17.5 22l2.65-3.44c1.17-1.07 1.17-2.61.22-3.55-.01-.01-.02-.01-.08.39"/>',
...
// Substituir todos os <i data-lucide="..."> por SVGs inline
function _lucideCreateIcons(root) {
  ...
  scope.querySelectorAll('i[data-lucide]').forEach(el => {
    ...
    // Extrair tamanho do class (w-4 = 16px, w-6 = 24px, w-8 = 32px)
    ...
    if (cls) svg.setAttribute('class', cls.replace(/\bw-\d+\b/g,'').replace(/\bh-\d+\b/g,'').trim());
...
// Compatibilidade: window.lucide.createIcons() agora chama o nosso sistema local
window.lucide = { createIcons: () => _lucideCreateIcons(document) };
// Também expor globalmente
